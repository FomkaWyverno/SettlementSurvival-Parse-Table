...
public class Config {
    ...
    private Config() throws NoSuchFileException {
        try {
            ...
            this.properties.put("with-code", "false");
    ...
    public boolean isWithCode() {
        switch (this.properties.getProperty("with-code")) {
            case "true" -> {return true;}
            case "false" -> {return false;}
            default -> throw new RuntimeException("Value in config file - \"with-code\" not boolean type!");
        }
    }
}
